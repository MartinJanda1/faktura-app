...
2. Předej soubor **`dist/MJ-Faktura-1.0.0-portable.exe`**
...
Výstup: **`desktop/dist/MJ-Faktura-1.0.0-portable.exe`**

Instalační verze (NSIS): `npm run dist:installer` → `MJ-Faktura-1.0.0-setup.exe`
