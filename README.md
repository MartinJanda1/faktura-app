...
**Verze:** 1.3.0 — změny viz [CHANGELOG.md](CHANGELOG.md).
...
Výstup: **`desktop/dist/MJ-Faktura-1.3.0-portable.exe`** — není potřeba instalace, stačí spustit soubor.
...
2. Zkopíruj `MJ-Faktura-1.3.0-portable.exe` kamkoli (USB, Plocha)
